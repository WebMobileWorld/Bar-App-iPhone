...
@interface DirectionListViewController ()<FPPopoverControllerDelegate>
{
    //POPOVER
...
@implementation DirectionListViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view, typically from a nib.
    
    self.navigationItem.titleView = [CommonUtils setTitleLabel:@"DIRECTION LIST"];
...
-(void)btnFilterClicked:(id)sender
{
    ...
    controller.directionListDelegate = self;
...
{
    return [CommonUtils getArrayCountFromArray:self.aryDirections];
}
...
- (void)configureGetDirectionDetailCell:(GetDirectionDetailCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    MKRouteStep *step = [self.aryDirections objectAtIndex:indexPath.row];
