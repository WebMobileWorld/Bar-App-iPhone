...
//    picker.modalPresentationStyle = UIModalPresentationCurrentContext;
    ...
    /*
    if (appDel.whoIam) {
        [picker setVideoMaximumDuration:40.0];
    }else
    {*/
        [picker setVideoMaximumDuration:60.0];
    //}
...
//            self.assetsFilter = [ALAssetsFilter allVideos];
            ...
            if(_maximumNumberOfSelection > 1)
                ...
                self.labelSelectedMedia.text = NSLocalizedStringFromTable(@"Choose video", @"UzysAssetsPickerController", nil);
        }
...
//            self.assetsFilter = [ALAssetsFilter allPhotos];
            ...
            if(_maximumNumberOfSelection >1)
                ...
                self.labelSelectedMedia.text = NSLocalizedStringFromTable(@"Choose photo", @"UzysAssetsPickerController", nil);
        }
        else
        {
...
{
//    ALAsset *representation = [self.assets objectAtIndex:indexPath.item];
//    
...
//    totalImgSize = imageSize + totalImgSize;
//    NSLog(@"SIZE OF IMAGE: %.2f ", totalImgSize);
//    NSLog(@"SIZE OF IMAGE: %.2f Mb", (float)totalImgSize/1024/1024);
//    return YES;
    NSLog(@"%lu",(unsigned long)[collectionView indexPathsForSelectedItems].count);
...
//    NSData *imageData = UIImagePNGRepresentation(img);
//    CGFloat imageSize = imageData.length;
//    totalImgSize = totalImgSize - imageSize;
//    NSLog(@"SIZE OF IMAGE: %.2f ", totalImgSize);
//    
//    
//    NSLog(@"SIZE OF IMAGE: %.2f Mb", (float)totalImgSize/1024/1024);
