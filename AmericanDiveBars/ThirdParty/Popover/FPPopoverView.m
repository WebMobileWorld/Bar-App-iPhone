...
-(CGGradientRef)newCustomGradient {
    UIColor *lightGradientColor = [UIColor colorWithRed:76.0/255.0 green:65.0/255.0 blue:41.0/255.0 alpha:1.0];
    UIColor *darkGradientColor = [UIColor colorWithRed:76.0/255.0 green:65.0/255.0 blue:41.0/255.0 alpha:1.0];
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGGradientRef gradient = [self newCustomGradient];
    ...
    //content fill
    CGPathRef contentPath = [self newContentPathWithBorderWidth:0.0 arrowDirection:_arrowDirection];
    ...
    if(self.tint == FPPopoverBlackTint)
    {
        //[UIColor colorWithRed:189.0/255. green:127.0/255.0 blue:52.0/255.0 alpha:1.0]
        //CGContextSetRGBFillColor(ctx, 0.1, 0.1, 0.1, 1.0);
        //[UIColor colorWithRed:76.0/255.0 green:65.0/255.0 blue:41.0/255.0 alpha:1.0]
        CGContextSetRGBFillColor(ctx, 76.0/255.0, 65.0/255.0, 41.0/255.0, 1.0);
    }
    else if(self.tint == FPPopoverLightGrayTint)
    {
